...
def txt_to_nparray(path:str):
    with open(path) as file:
        return np.asarray([[float(word.strip()) for word in line.split(' ')] for line in file])

def png_to_ndarray(path:str):
    pass    
